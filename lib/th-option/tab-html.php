...
<div class="th-option-area">
        ...
        <div class="th-option-bottom-hdr">
            ...
            <a class="tablinks" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Import Demo Content','m-shop');?> </a>
            <a class="tablinks" onclick="openTab(event, 'Recommanded-Plugin')"><?php _e('Recommanded Plugin','m-shop');?> </a>
